...
from pystyle import Colors, Colorate   # <== thêm vào đây
# ===== Màu ANSI =====
...
def banner():
    ascii_text = r"""
       ...
       -----------------------------------------------------------------
    """
    # In banner với màu gradient xanh dương → hồng
    print(Colorate.Horizontal(Colors.blue_to_purple, ascii_text))    
    # In khung thông tin
    print(f"{BOLD}{RED}╔═══════════════════════════════════════════════╗{RESET}")
    print(f"{BOLD}{RED}║{RESET}  {BOLD}Admin :{RESET} CTEVCL".ljust(45) + f"{BOLD}{RED}                        ║{RESET}")
    print(f"{BOLD}{RED}║{RESET}  {BOLD}FB    :{RESET} Cte Vcl".ljust(45) + f"{BOLD}{RED}                        ║{RESET}")
    print(f"{BOLD}{RED}║{RESET}  {BOLD}TELE  :{RESET} @ctevclwar".ljust(45) + f"{BOLD}{RED}                        ║{RESET}")
    print(f"{BOLD}{RED}╚═══════════════════════════════════════════════╝{RESET}\n")
...
def main_menu():
    while True:
        ...
        print(f"{BOLD}{CYAN}║{RESET} {GREEN}=>1{RESET} {BOLD}TOOL WAR MESSENGER {RESET}".ljust(47) + f"{BOLD}{CYAN}                       ║{RESET}")
        print(f"{BOLD}{CYAN}║{RESET} {YEL}=>2{RESET} {BOLD}TOOL SPAM SMS{RESET}".ljust(47) + f"{BOLD}{CYAN}                             ║{RESET}")
        print(f"{BOLD}{CYAN}║{RESET} {CYAN}=>0{RESET} {BOLD}CÚT{RESET}".ljust(47) + f"{BOLD}{CYAN}                               ║{RESET}")
        print(f"{BOLD}{CYAN}╚═══════════════════════════════════════════════╝{RESET}")
        choice = input(f"\n{BOLD}Chọn:{RESET} ").strip()

        if choice == "1":
            clear(); banner()
            print(f"{YEL}>TOOL WAR MESSENGER< Đang vào tool...{RESET}\n")
            try: exec(TOOL26_CODE, globals())
            except Exception as e: print(f"{RED}[Lỗi TOOL 1]{RESET} {e}")
            pause()
        elif choice == "2":
            clear(); banner()
            print(f"{YEL}>TOOL SPAM SMS< Đang vào tool...{RESET}\n")
